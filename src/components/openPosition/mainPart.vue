    ...
    <div class="main2">
      <div class="cols">
        <div class="col1">
          ...
          <img class="avatar" src="/src/assets/avatar2.png" />
        </div>
        <div class="col3"></div>
      </div>
      <div class="filters">
        ...
        <div class="content">
          <div class="filter" style="border-bottom: 4px solid #a100ff">
            <div class="blur"></div>
            <h3>Web Design</h3>
            <p>Descrizione di web design.</p>
            <p class="icon">></p>
          </div>
          <div class="filter" style="border-bottom: 4px solid #0083ff">
            <div class="blur"></div>
            <h3>Web Design</h3>
            <p>Descrizione di web design.</p>
            <p class="icon">></p>
          </div>
          <div class="filter" style="border-bottom: 4px solid #ff6300">
            <div class="blur"></div>
            <h3>Web Design</h3>
            <p>Descrizione di web design.</p>
            <p class="icon">></p>
          </div>
          <div class="filter" style="border-bottom: 4px solid #006da5">
            <div class="blur"></div>
            <h3>Web Design</h3>
            <p>Descrizione di web design.</p>
            <p class="icon">></p>
        ...
        <div class="content">
          ...
          <div class="filter" style="border-bottom: 4px solid #b90089">
            <div class="blur"></div>
            <h3>Web Design</h3>
            <p>Descrizione di web design.</p>
            <p class="icon">></p>
          </div>
          <div class="filter" style="border-bottom: 4px solid #b9b500">
            <div class="blur"></div>
            <h3>Web Design</h3>
            <p>Descrizione di web design.</p>
            <p class="icon">></p>
          </div>
          <div class="filter" style="border-bottom: 4px solid #b90000">
            <div class="blur"></div>
            <h3>Web Design</h3>
            <p>Descrizione di web design.</p>
            <p class="icon">></p>
          ...
          <div class="position">
            ...
            <div class="content">
              <div
                class="header"
                style="
                  background-image: url(/src/assets/web_dev.png);
...
@media (min-width: 1024px) {
  ...
  .filters .filter {
    padding: 2rem;
    background: rgba(78, 78, 78, 0.267);
    border-radius: 10px;
    width: 25%;
  ...
  .positions .position .header p {
    color: #fff;
    font-size: 16px;
    line-height: 20px;
  }

  .positions .position .content .desc {
    padding: 1rem;
  }

  .positions .position .content .desc h3 {
    color: #fff;
    font-size: 30px;
    line-height: 30px;
    font-weight: 700;
  ...
  .positions .position .content .desc h4 {
    color: #fff;
    font-size: 18px;
    line-height: 22px;
    font-weight: 300;
  ...
  .positions .position .content .desc p {
    color: #fff;
    font-size: 16px;
    font-weight: 300;
    margin-top: 0.5rem;
              ...
              <div class="position">
                ...
                <div class="content">
                  <div class="left">
                    <h2>Web developer</h2>
                    <p>
                      Sei appassionato di informatica e vuoi acquisire
                      competenze nel settore? la specializzazione digital &
                      technologies.
                    </p>
                    <div class="info">
                      <p>• &nbsp;Milano</p>
